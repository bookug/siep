...
#include <new>
//NOTICE: hashmap is not in C++11
//#include <ext/hash_map> 
//using namespace stdext;
#include <unordered_map>   //supported by C++11
...
public:
    ...
    static void readIntegersFromString(std::string stringContents, std::vector<int>& numbers);
