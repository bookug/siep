...
int Util::bsearch_vec_uporder(int _key, vector<int>& _vec) {
...
//NOTICE:_b must >= 1
double Util::logarithm(double _a, double _b) {
...
void Util::intersect(vector<int>& res, vector<int>& tmp) {
	vector<int> res2;
...
void Util::timeLimit(int seconds) {
